...
node_address=$(rapidd keys list | grep  "address: " | cut -c12-)
...
rapidd start "$TRACE" --log_level $LOGLEVEL --minimum-gas-prices=0.0001arapid --json-rpc.enable true --json-rpc.api eth,txpool,personal,net,debug,web3 --api.enable
