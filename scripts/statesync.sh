...
# Initialize chain.
rapidd init test --chain-id evmos_9000-2

# Get Genesis
wget https://archive.evmos.org/mainnet/genesis.json
mv genesis.json ~/.rapidd/config/

wget -O ~/.rapidd/config/adrbook.json https://snapshot.notional.ventures/evmos/addrbook.json
...
export rapidd_P2P_MAX_NUM_INBOUND_PEERS=200
export rapidd_P2P_MAX_NUM_OUTBOUND_PEERS=200
export rapidd_STATESYNC_RPC_SERVERS="https://evmos-rpc.polkachu.com:443,https://rpc-evmos-ia.notional.ventures:443"
