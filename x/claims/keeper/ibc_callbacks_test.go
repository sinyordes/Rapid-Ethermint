	...
	testCases := []struct {
		...
		},
		{
			...
			func() {
				...
				transfer := transfertypes.NewFungibleTokenPacketData("arapid", "100", senderStr, blockedAddr.String(), "")
		...
		},
		{
			...
			func() {
				transfer := transfertypes.NewFungibleTokenPacketData("arapid", "100", senderStr, receiverStr, "")
				bz := transfertypes.ModuleCdc.MustMarshalJSON(&transfer)
				packet := channeltypes.NewPacket(bz, 1, transfertypes.PortID, "channel-0", transfertypes.PortID, "channel-0", timeoutHeight, 0)
		...
		},
		{
			"fail - invalid sender",
			func() {
				transfer := transfertypes.NewFungibleTokenPacketData("arapid", "100", "evmos", receiverStr, "")
				bz := transfertypes.ModuleCdc.MustMarshalJSON(&transfer)
				packet := channeltypes.NewPacket(bz, 1, transfertypes.PortID, "channel-0", transfertypes.PortID, "channel-0", timeoutHeight, 0)
		...
		},
		{
			...
			func() {
				transfer := transfertypes.NewFungibleTokenPacketData("arapid", "100", "badba1sv9m0g7ycejwr3s369km58h5qe7xj77hvcxrms", receiverStr, "")
				bz := transfertypes.ModuleCdc.MustMarshalJSON(&transfer)
				packet := channeltypes.NewPacket(bz, 1, transfertypes.PortID, "channel-0", transfertypes.PortID, "channel-0", timeoutHeight, 0)
		...
		},
		{
			...
			func() {
				transfer := transfertypes.NewFungibleTokenPacketData("arapid", "100", receiverStr, "badbadhf0468jjpe6m6vx38s97z2qqe8ldu0njdyf625", "")
				bz := transfertypes.ModuleCdc.MustMarshalJSON(&transfer)
				packet := channeltypes.NewPacket(bz, 1, transfertypes.PortID, "channel-0", transfertypes.PortID, "channel-0", timeoutHeight, 0)
		...
		},
		{
			...
			func() {
				transfer := transfertypes.NewFungibleTokenPacketData("arapid", "100", secpAddrCosmos, secpAddrEvmos, "")
				bz := transfertypes.ModuleCdc.MustMarshalJSON(&transfer)
				packet := channeltypes.NewPacket(bz, 1, transfertypes.PortID, "channel-0", transfertypes.PortID, "channel-0", timeoutHeight, 0)
		...
		},
		{
			...
			func() {
				transfer := transfertypes.NewFungibleTokenPacketData("arapid", types.IBCTriggerAmt, senderStr, receiverStr, "")
				bz := transfertypes.ModuleCdc.MustMarshalJSON(&transfer)
				packet := channeltypes.NewPacket(bz, 1, transfertypes.PortID, "channel-0", transfertypes.PortID, "channel-0", timeoutHeight, 0)
		...
		},
		{
			...
			func() {
				transfer := transfertypes.NewFungibleTokenPacketData("arapid", "100", secpAddrCosmos, receiverStr, "")
				bz := transfertypes.ModuleCdc.MustMarshalJSON(&transfer)
				packet := channeltypes.NewPacket(bz, 1, transfertypes.PortID, "channel-0", transfertypes.PortID, "channel-0", timeoutHeight, 0)
