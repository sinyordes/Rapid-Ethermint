...
func (suite *IncentiveTestSuite) TestIncentiveNew() {
	testCases := []struct {
	...
	}{
		{
			...
			sdk.DecCoins{sdk.NewDecCoinFromDec("arapid", sdk.NewDecWithPrec(5, 2))},
			10,
			true,
		},
		{
		...
		},
		{
			...
			utiltx.GenerateAddress(),
			sdk.DecCoins{sdk.NewDecCoinFromDec("arapid", sdk.NewDecWithPrec(0, 2))},
			10,
			false,
		},
		{
			...
			utiltx.GenerateAddress(),
			sdk.DecCoins{sdk.NewDecCoinFromDec("arapid", sdk.NewDecWithPrec(101, 2))},
			10,
			false,
		},
		{
